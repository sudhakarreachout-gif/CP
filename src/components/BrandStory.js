...
function StatCounter({ target, suffix = '', label }) {
  ...
  return (
    <div ref={elementRef} className="space-y-2">
      <div className="text-[48px] md:text-[56px] font-serif font-bold text-espresso leading-none">
        {target % 1 === 0 ? Math.floor(count) : count.toFixed(1)}{suffix}
      </div>
      <p className="text-[14px] font-jakarta font-semibold text-text-muted uppercase tracking-wider">
        {label}
      </p>
      <div className="w-12 h-1 bg-terracotta/30 rounded-full" />
    </div>
  )
}
...
export default function BrandStory() {
  return (
    <section id="about" className="section-padding bg-gradient-to-r from-[#FDF6EE] to-[#F5ECD8] overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="space-y-4">
              <span className="text-terracotta font-nunito font-bold uppercase tracking-[0.2em] text-sm">
                Our Philosophy
              </span>
              <h2 className="text-[42px] md:text-[48px] font-serif font-bold text-espresso leading-[1.1]">
                Driven by Love, <br />
            ...
            <div className="space-y-6 max-w-[400px]">
              <p className="text-[15px] font-jakarta text-text-muted leading-[1.7]">
            ...
            <div className="mt-[28px]">
              <a href="#newsletter">
                <button className="btn-primary clickable">Join the Family</button>
              </a>
            </div>
          </motion.div>
